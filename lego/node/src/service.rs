...
async fn start_lego_node_impl<RuntimeApi, Executor, RB, BIQ, BIC>(
...
) -> Result<Box<dyn ParachainConsensus<Block>>, sc_service::Error>,
{
	...
	// Used before and after v0.9.16 but seen at different lines
	...
	sc_service::build_network(sc_service::BuildNetworkParams {
		...
		// Possibly obsolete code at v0.9.15
...
pub fn lego_build_import_queue<RuntimeApi, Executor>(
