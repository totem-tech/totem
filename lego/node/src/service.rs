...
pub fn lego_parachain_build_import_queue<RuntimeApi, Executor>(
...
pub async fn start_lego_parachain_node<RuntimeApi, LegoRuntimeExecutor>(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	id: ParaId,
) -> sc_service::error::Result<(
...
where
	RuntimeApi: ConstructRuntimeApi<Block, TFullClient<Block, RuntimeApi, NativeElseWasmExecutor<LegoRuntimeExecutor>>>
		+ Send
		+ Sync
		+ 'static,
	RuntimeApi::RuntimeApi: sp_transaction_pool::runtime_api::TaggedTransactionQueue<Block>
		...
		+ frame_rpc_system::AccountNonceApi<Block, AccountId, Nonce>,
	sc_client_api::StateBackendFor<TFullBackend<Block>, Block>: sp_api::StateBackend<BlakeTwo256>,
	LegoRuntimeExecutor: sc_executor::NativeExecutionDispatch + 'static,
{
	start_node_impl::<RuntimeApi, LegoRuntimeExecutor, _, _, _>(
		parachain_config,
		polkadot_config,
		id,
		|_| Ok(Default::default()),
		lego_parachain_build_import_queue,
		|client,
		prometheus_registry,
		telemetry,
		task_manager,
