...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("lego-totem"),
	impl_name: create_runtime_str!("lego-totem"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Funding: pallet_funding::{Pallet, Call, Storage, Event<T>, Config<T>},
