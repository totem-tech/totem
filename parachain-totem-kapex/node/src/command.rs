...
use log::info;
use parachain_totem_kapex_runtime::{Block, RuntimeApi};
...
fn load_spec(
	...
	Ok(match id {
		...
		"" | "totem" | "kapex" => Box::new(chain_spec::totem_kapex_config()?),
...
impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"Totem KAPEX Parachain Node".into()
	}
	...
	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&parachain_totem_kapex_runtime::VERSION
	}
}

impl SubstrateCli for RelayChainCli {
	fn impl_name() -> String {
		"Totem KAPEX Parachain Collator".into()
	}
	...
	fn description() -> String {
		"Totem KAPEX Parachain Collator\n\nThe command-line arguments provided first will be \
		passed to the parachain node, while the arguments provided after -- will be passed \
		to the relaychain node.\n\n\
