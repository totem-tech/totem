...
use sp_runtime::traits::{Convert as _, Zero};
use sp_std::marker::PhantomData;
use xcm::latest::{AssetId, Fungibility::Fungible, MultiAsset, MultiLocation};
use xcm_executor::traits::FilterAssetLocation;

use totem_primitives::accounting::Posting as _;
    ...
    <R as frame_system::Config>::Event: From<pallet_balances_totem::Event<R>>,
{
    fn on_nonzero_unbalanced(amount: NegativeImbalance<R>) {
        ...
        // Totem accounting:
        if let Err(_e) = R::Accounting::distribute_fees_rewards(numeric_amount, staking_pot.clone())
        {
            // What to do when there is an error? (When an u128 cannot be converted to an i128)
            // This is quite a theoretical concern, though, since I don't really think it can happen.
        }
...
where
    R: pallet_authorship::Config + pallet_assets::Config + pallet_balances_totem::Config,
    AccountIdOf<R>:
        From<polkadot_primitives::v1::AccountId> + Into<polkadot_primitives::v1::AccountId>,
{
    fn handle_credit(credit: CreditOf<AccountIdOf<R>, pallet_assets::Pallet<R>>) {
        ...
        //let actual_fee = R::BalancesConverter::convert(credit.amount);
        let actual_fee = credit.peek();

        if let Err(_e) = R::Accounting::distribute_fees_rewards(actual_fee, author) {
            // What to do when there is an error? (When an u128 cannot be converted to an i128)
            // This is quite a theoretical concern, though, since I don't really think it can happen.
        }
    }
...
mod tests {
    ...
    frame_support::construct_runtime!(
            ...
            UncheckedExtrinsic = UncheckedExtrinsic,
        {
            ...
            Balances: pallet_balances_totem::{Pallet, Call, Storage, Config<T>, Event<T>},
    ...
    pub fn new_test_ext() -> sp_io::TestExternalities {
        ...
        pallet_balances_totem::GenesisConfig::<Test>::default()
