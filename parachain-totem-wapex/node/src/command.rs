...
use log::info;
use parachain_totem_wapex_runtime::{Block, RuntimeApi};
...
fn load_spec(
	...
	Ok(match id {
		...
		"" | "totem" | "wapex" => Box::new(chain_spec::totem_wapex_config()?),
...
impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"Totem WAPEX Parachain Node".into()
	}
	...
	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&parachain_totem_wapex_runtime::VERSION
	}
}

impl SubstrateCli for RelayChainCli {
	fn impl_name() -> String {
		"Totem WAPEX Parachain Collator".into()
	}
	...
	fn description() -> String {
		"Totem WAPEX Parachain Collator\n\nThe command-line arguments provided first will be \
		passed to the parachain node, while the arguments provided after -- will be passed \
		to the relaychain node.\n\n\
